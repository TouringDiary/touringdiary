-- ==========================================
-- WF-02 STEP-2 Fase 2.3 — Unificazione attivazione (DOC 29 Fase 3 / DL-017 / B3)
-- Date: 2026-07-14
-- Closes: B3 (split createSponsorFromRequest + activate_sponsor_with_resource)
-- Out of scope: cancel/extend contracts (Fase 2.4), shop sync (Fase 2.4)
-- ==========================================

BEGIN;

-- ---------------------------------------------------------------------------
-- 1. activate_sponsor_from_request — percorso atomico unico (DL-017)
--    INSERT sponsors + risorsa + subscription + converted request
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 2. Legacy RPC — non più invocabile dal client (O9 / DL-017)
-- ---------------------------------------------------------------------------
