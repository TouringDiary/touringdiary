...
export const PHOTO_FILTER_PRESETS: readonly PhotoFilterPreset[] = [
  ...
  },
  {
    id: 'vivid',
    label: 'Vivace',
    adjustments: { brightness: 105, contrast: 115, saturation: 130 },
  },
  ...
  { id: 'cool', label: 'Freddo', adjustments: { brightness: 102, contrast: 108, saturation: 90 } },
  {
    id: 'dramatic',
    label: 'Drammatico',
    adjustments: { brightness: 95, contrast: 130, saturation: 110 },
  },
  ...
  { id: 'mono', label: 'B&N', adjustments: { brightness: 105, contrast: 115, saturation: 0 } },
  {
    id: 'sunset',
    label: 'Tramonto',
    adjustments: { brightness: 112, contrast: 110, saturation: 125 },
  },
] as const;
