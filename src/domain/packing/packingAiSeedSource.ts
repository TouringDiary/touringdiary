/** Dati seed AI — sorgente strutturata condivisa (seed SQL + motore AI legacy). */
...
export const TAG_ITEM_MAP: Record<string, PackingSeedItem[]> = {
  mare: [
    ...
    { name: 'Custodia impermeabile smartphone', category: 'Accessori' },
  ],
  montagna: [
    ...
    { name: 'Borraccia termica', category: 'Accessori' },
  ...
  business: [
    ...
    { name: 'Organizer cavi', category: 'Accessori' },
  ...
  volo: [
    ...
    { name: 'Cuscino cervicale', category: 'Accessori' },
    { name: 'Mascherina occhi 3D', category: 'Accessori' },
    { name: 'Tappi orecchie', category: 'Accessori' },
    { name: 'Bilancia bagaglio', category: 'Accessori' },
    { name: 'Lucchetto TSA', category: 'Accessori' },
    { name: 'Etichette bagaglio', category: 'Accessori' },
    { name: 'Porta passaporto RFID', category: 'Accessori' },
  ...
  treno: [
    ...
    { name: 'Cuscino da viaggio', category: 'Accessori' },
  ],
  freddo: [
  ...
  caldo: [
    ...
    { name: 'Borraccia ghiacciata', category: 'Accessori' },
  ],
  pioggia: [
  ...
  weekend: [
    ...
    { name: 'Beauty case compatto', category: 'Accessori' },
  ],
  lungo_raggio: [
    { name: 'Packing Cubes', category: 'Accessori' },
    { name: 'Kit lavaggio panni', category: 'Igiene' },
    { name: 'Lucchetto extra', category: 'Accessori' },
  ...
  igiene_completa: [
    ...
    { name: 'Flaconi viaggio silicone', category: 'Accessori' },
  ],
  abbigliamento_base: [
  ...
  elettronica_completa: [
    ...
    { name: 'Adattatore universale', category: 'Accessori' },
    { name: 'Smartwatch', category: 'Elettronica' },
  ],
};

export const UNIVERSAL_DEFAULTS: PackingSeedItem[] = [
  ...
  { name: 'Lucchetto valigia', category: 'Accessori' },
];
