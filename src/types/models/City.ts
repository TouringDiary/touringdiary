...
export interface PointOfInterest {
  ...
  /** Assente = nessun rating community noto (non usare 0 come placeholder). */
  rating?: number;
  /** Assente = nessun conteggio voti community noto. */
  votes?: number;
...
export interface CityEvent {
  ...
  cityName?: string;
  cityBadge?: string;
  /** Payload evento esteso (AI/Global Events); tipizzato largo per non forzare writer fuori C3. */
