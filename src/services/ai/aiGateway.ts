...
import { type AiRequestOptions, supabaseProvider } from './providers/supabaseProvider';
...
export class AiGateway {
  ...
  async generateLegacy(
    ...
    options?: Pick<AiRequestOptions, 'feature'>,
  ): Promise<ReturnType<typeof wrapLegacyResponse>> {
