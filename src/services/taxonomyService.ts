import type { DatabaseTaxonomyMapping } from '../types/database';
...
export const getTaxonomyRules = async (
  context: 'poi' | 'event' = 'poi',
...
export const addTaxonomyRule = async (
  term: string,
  cat: string,
  sub: string,
  tab: string,
...
export const updateTaxonomyRule = async (
  id: string,
  term: string,
  cat: string,
  sub: string,
...
export const getTaxonomyDictionary = async (
  context: 'poi' | 'event' = 'poi',
): Promise<Record<string, { cat: string; sub: string; tab: string }>> => {
