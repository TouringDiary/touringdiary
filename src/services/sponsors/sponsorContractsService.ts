...
import type { ResolvedSponsor, Sponsor, SponsorRequest } from '../../types/models/Sponsor';
 ...
 */
export const fetchActiveSponsorsResolvedAsync = async (
  cityId?: string,
 ...
 */
export const fetchSponsorsByCityIdsAsync = async (
  cityIds: string[],
 ...
 */
export const startShopSubscription = async (
  _sponsorId: string,
