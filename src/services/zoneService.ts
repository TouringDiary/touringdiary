import type { AiCitySuggestion, TouristZone } from '../types/index';
...
export const ensureZoneExists = async (
  zoneName: string,
  adminRegion: string,
): Promise<{ created: boolean; log: string }> => {
...
export const renameTouristZone = async (
  oldName: string,
  newName: string,
  regionName: string,
): Promise<void> => {
...
export const saveZoneSuggestions = async (
  zoneName: string,
  suggestions: AiCitySuggestion[],
  regionName: string,
) => {
...
export const removeZoneSuggestion = async (
  zoneName: string,
