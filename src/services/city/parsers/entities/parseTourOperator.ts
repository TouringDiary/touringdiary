import type { CityTourOperator } from '../../../../types';
 ...
 */
export const parseTourOperator = (raw: unknown): CityTourOperator => {
  ...
  return {
    ...
    reviews: raw.reviews as CityTourOperator['reviews'],
    ...
    openingHours: (raw.opening_hours ?? undefined) as CityTourOperator['openingHours'],
