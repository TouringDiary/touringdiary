import type { Database, DatabaseCityTourOperatorInsert, Json } from '../../types/database';
...
export const mapToTourOperatorInput = (
  item: Record<string, unknown>,
): SaveCityTourOperatorInput => {
  if ('contact' in item) {
...
export const getCityTourOperatorsByCityIds = async (
  cityIds: string[],
