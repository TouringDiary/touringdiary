...
/** Label UI Centro di Controllo → Moderazione per `feature.moderation.community_posts`. */
const MODERATION_COMMUNITY_POSTS_LABEL = 'Consigli Community';
  ...
  return {
    ...
    label:
      row.key === PLATFORM_FEATURE_FLAG_KEYS.COMMS_USER_SPONSOR
        ...
        : row.key === PLATFORM_FEATURE_FLAG_KEYS.MODERATION_COMMUNITY_POSTS
          ? MODERATION_COMMUNITY_POSTS_LABEL
          : row.label,
    valueType,
