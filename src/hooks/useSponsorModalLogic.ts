...
import type { ActivationData, CancelData, ExtensionData, RejectData } from './useSponsorModals';
 ...
 */
export const useSponsorModalLogic = (modalState: SponsorModalState, requests: SponsorRequest[]) => {
