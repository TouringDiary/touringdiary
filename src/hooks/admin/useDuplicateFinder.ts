      ...
      try {
        ...
        for (let i = 0; i < total; i++) {
          ...
          for (let j = i + 1; j < total; j++) {
            ...
            if (a.coords && b.coords && a.coords.lat !== 0 && b.coords.lat !== 0) {
              distMeters =
                calculateDistance(a.coords.lat, a.coords.lng, b.coords.lat, b.coords.lng) * 1000;
