  ...
  return (
    <div>
      <div className="flex items-center gap-1.5 mb-1">
        <label
          htmlFor="fld-admin-design-styleeditor-tsx-l44"
      ...
      <select
        id="fld-admin-design-styleeditor-tsx-l44"
        value={value}
...
const StyleEditor: React.FC<StyleEditorProps> = ({ rule, onChange }) => {
  ...
  if (!rule) {
    return (
      <div className="p-6 text-center text-slate-400">Seleziona un componente da modificare.</div>
    );
  }
  ...
  return (
    <div className="bg-slate-900 p-6 rounded-lg space-y-8">
      ...
      <div>
        ...
        <label
          htmlFor="fld-admin-design-styleeditor-tsx-l212"
          className="block text-xs font-semibold text-slate-400 mb-1 uppercase"
        >
          css_class
        </label>
        <input
          id="fld-admin-design-styleeditor-tsx-l212"
          type="text"
          value={utilityDraft}
      ...
      <div>
        <label
          htmlFor="fld-admin-design-styleeditor-tsx-l233"
          className="block text-xs font-semibold text-slate-400 mb-1 uppercase"
        >
          Preview Text
        </label>
        <input
          id="fld-admin-design-styleeditor-tsx-l233"
          type="text"
