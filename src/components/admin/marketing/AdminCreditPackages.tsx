      ...
      <div className="flex justify-between items-center bg-slate-900 p-6 rounded-3xl border border-slate-800 shadow-xl">
        <div>
          <h2 className="text-xl font-black text-white uppercase tracking-tight">
            Gestione Pacchetti Crediti
          </h2>
          <p className="text-xs text-slate-500 font-bold uppercase mt-1">
            Configura le offerte extra per gli utenti
          </p>
        </div>
        <button
          type="button"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {packages.map((pkg) => (
          ...
          >
            ...
            {!pkg.is_active && (
              <div className="absolute top-4 right-4 px-2 py-1 bg-rose-500/10 border border-rose-500/30 rounded text-[8px] font-black text-rose-500 uppercase">
                Non Attivo
              </div>
            )}
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between p-2 bg-slate-950/30 rounded-lg border border-slate-800/50">
                ...
                <span className="text-[9px] font-mono text-indigo-400 truncate ml-4">
                  {pkg.stripe_price_id_test || 'NON CONFIGURATO'}
                </span>
              </div>
              <div className="flex items-center justify-between p-2 bg-slate-950/30 rounded-lg border border-slate-800/50">
                <span className="text-[9px] font-bold text-slate-600 uppercase tracking-widest">
                ...
                <span className="text-[9px] font-mono text-rose-400 truncate ml-4">
                  {pkg.stripe_price_id_prod || 'NON CONFIGURATO'}
                </span>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <div className="p-8 border-b border-slate-800 bg-gradient-to-r from-indigo-900/20 to-slate-900">
                <div>
                  ...
                  <p className="text-xs text-slate-500 font-bold uppercase mt-1">
                    Configurazione parametri Stripe e crediti
                  </p>
                </div>
              </div>
              ...
              <div className="p-8 space-y-6 flex-1 overflow-y-auto custom-scrollbar">
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label
                      htmlFor="fld-admin-marketing-admincreditpackages-tsx-l233"
                      className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1"
                    >
                      Nome Pacchetto
                    </label>
                    <input
                      id="fld-admin-marketing-admincreditpackages-tsx-l233"
                      type="text"
                      value={editing.name}
                  ...
                  <div className="space-y-2">
                    <label
                      htmlFor="fld-admin-marketing-admincreditpackages-tsx-l245"
                      className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1"
                    >
                      Prezzo (€)
                    </label>
                    <input
                      id="fld-admin-marketing-admincreditpackages-tsx-l245"
                      type="number"
                      step="0.01"
                      value={editing.price_eur}
                      onChange={(e) =>
                        setEditing({ ...editing, price_eur: parseFloat(e.target.value) })
                      }
                      className="w-full bg-slate-950 border border-slate-800 rounded-2xl p-4 text-white font-bold outline-none focus:border-indigo-500 transition-colors"
                    />
                  </div>
                ...
                <div className="space-y-2">
                  <label
                    htmlFor="fld-admin-marketing-admincreditpackages-tsx-l261"
                    className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1"
                  >
                    Descrizione Breve
                  </label>
                  <textarea
                    id="fld-admin-marketing-admincreditpackages-tsx-l261"
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label
                      htmlFor="fld-admin-marketing-admincreditpackages-tsx-l274"
                      className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1"
                    >
                      Crediti Flash
                    </label>
                    <div className="relative">
                      ...
                      <input
                        id="fld-admin-marketing-admincreditpackages-tsx-l274"
                        type="number"
                        value={editing.flash_credits}
                        onChange={(e) =>
                          setEditing({ ...editing, flash_credits: parseInt(e.target.value, 10) })
                        }
                  ...
                  <div className="space-y-2">
                    <label
                      htmlFor="fld-admin-marketing-admincreditpackages-tsx-l290"
                      className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1"
                    >
                      Crediti Pro
                    </label>
                    <div className="relative">
                      ...
                      <input
                        id="fld-admin-marketing-admincreditpackages-tsx-l290"
                        type="number"
                        value={editing.pro_credits}
                        onChange={(e) =>
                          setEditing({ ...editing, pro_credits: parseInt(e.target.value, 10) })
                        }
                        className="w-full bg-slate-950 border border-slate-800 rounded-2xl p-4 pl-12 text-white font-bold outline-none focus:border-indigo-500 transition-colors"
                      />
                    </div>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label
                      htmlFor="fld-admin-marketing-admincreditpackages-tsx-l309"
                      className="text-[10px] font-black text-rose-500 uppercase tracking-widest ml-1 flex items-center gap-1.5"
                    >
                      <AlertCircle className="w-3 h-3" /> Stripe Price ID (TEST)
                    </label>
                    <input
                      id="fld-admin-marketing-admincreditpackages-tsx-l309"
                      type="text"
                      value={editing.stripe_price_id_test}
                      onChange={(e) =>
                        setEditing({ ...editing, stripe_price_id_test: e.target.value })
                      }
                  ...
                  <div className="space-y-2">
                    <label
                      htmlFor="fld-admin-marketing-admincreditpackages-tsx-l323"
                      className="text-[10px] font-black text-emerald-500 uppercase tracking-widest ml-1 flex items-center gap-1.5"
                    >
                      <CheckCircle2 className="w-3 h-3" /> Stripe Price ID (PROD)
                    </label>
                    <input
                      id="fld-admin-marketing-admincreditpackages-tsx-l323"
                      type="text"
                      value={editing.stripe_price_id_prod}
                      onChange={(e) =>
                        setEditing({ ...editing, stripe_price_id_prod: e.target.value })
                      }
                ...
                <div className="flex items-center gap-8 pt-4">
                  <label className="flex items-center gap-3 cursor-pointer group">
                    <div
                      className={`w-12 h-6 rounded-full relative transition-all ${editing.is_active ? 'bg-indigo-600 shadow-[0_0_10px_rgba(79,70,229,0.4)]' : 'bg-slate-800'}`}
                    >
                      <div
                        className={`absolute top-1 w-4 h-4 bg-white rounded-full transition-all ${editing.is_active ? 'left-7' : 'left-1'}`}
                      />
                    </div>
                    <input
                      type="checkbox"
                  ...
                  <label className="flex items-center gap-3 cursor-pointer group">
                    <div
                      className={`w-12 h-6 rounded-full relative transition-all ${editing.is_recommended ? 'bg-amber-500 shadow-[0_0_10px_rgba(245,158,11,0.4)]' : 'bg-slate-800'}`}
                    >
                      <div
                        className={`absolute top-1 w-4 h-4 bg-white rounded-full transition-all ${editing.is_recommended ? 'left-7' : 'left-1'}`}
                      />
                    </div>
                    <input
                      type="checkbox"
