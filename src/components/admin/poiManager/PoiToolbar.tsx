...
interface PoiToolbarProps {
    state: {
        viewStatus: PointOfInterest['status'] | 'all';
    ...
    actions: {
        setViewStatus: (s: PointOfInterest['status'] | 'all') => void;
                    ...
                    <div className="flex p-1 bg-slate-950 rounded-xl border border-slate-800 overflow-x-auto flex-1 md:flex-none">
                        {[
                            ...
                            return (
                                <button
                                    key={st.id}
                                    onClick={() => actions.setViewStatus(st.id as PointOfInterest['status'] | 'all')}
