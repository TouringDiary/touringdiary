...
export const CultureHistory: React.FC<CultureHistoryProps> = ({
  ...
  return (
    <div className="flex flex-col gap-6 md:gap-8 lg:h-full lg:min-h-0">
      {/* STORIA IN BREVE */}
      <div className="flex flex-col bg-slate-900 p-4 md:p-8 rounded-2xl md:rounded-3xl border border-slate-800 shadow-2xl lg:flex-[1] lg:min-h-0">
        ...
        <textarea
          ...
          className="w-full lg:flex-1 lg:min-h-0 bg-slate-950 border border-slate-700 rounded-lg p-3 md:p-4 text-white text-sm resize-none"
        />
        <AiFieldHelper
      ...
      {/* STORIA COMPLETA */}
      <div className="flex flex-col bg-slate-900 p-4 md:p-8 rounded-2xl md:rounded-3xl border border-slate-800 shadow-2xl lg:flex-[3] lg:min-h-0">
        <div className="flex justify-between items-center mb-4 md:mb-6 border-b border-slate-800 pb-4">
          <h3 className="text-lg md:text-2xl font-bold text-white flex items-center gap-2">
        ...
        <textarea
          ...
          className="w-full lg:flex-1 lg:min-h-0 bg-slate-900 border border-slate-700 rounded-lg p-3 md:p-4 text-white text-sm resize-none"
        />
        <AiFieldHelper
