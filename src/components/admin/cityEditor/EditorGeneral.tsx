        ...
        <div className="space-y-8 animate-in fade-in relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wide block mb-1.5 flex justify-between">
                            Nome Città
                            <button onClick={handleFixName} className="text-indigo-400 hover:text-white flex items-center gap-1 text-[9px] uppercase"><Type className="w-3 h-3"/> Formatta</button>
                        </label>
                        <input 
                            value={city.name} 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                    <div>
                        ...
                        <p className="text-[10px] text-slate-500 mt-2 leading-relaxed italic">
                            Nota: Se più città hanno "Eventi in Arrivo", in Home Page apparirà quella con più visitatori stimati. Le altre saranno visibili nel pulsante "Esplora".
                        </p>
                    </div>
                    ...
                    <div className="bg-slate-950/50 p-6 rounded-2xl border border-slate-800 flex items-center justify-between">
                        ...
                        <label className="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" checked={city.isFeatured} onChange={e => updateField('isFeatured', e.target.checked)} className="sr-only peer"/>
            ...
            <div className="bg-slate-900 p-8 rounded-3xl border border-slate-800 shadow-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <input type="number" value={city.visitors} onChange={e => updateField('visitors', parseInt(e.target.value))} className="w-full bg-slate-950 border border-slate-700 rounded-xl p-3 text-white font-mono font-bold"/>
            ...
            <div className="bg-slate-900 p-8 rounded-3xl border border-slate-800 shadow-xl">
                ...
                <div className="flex justify-between items-center mt-2">
                    <span className={`text-[10px] font-bold ${city.description.length > 150 ? 'text-red-500' : 'text-slate-500'}`}>{city.description.length}/200</span>
                    <AiFieldHelper 
