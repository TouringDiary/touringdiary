    ...
    <div className="space-y-8 animate-in fade-in relative">
      ...
      <div className="bg-slate-900 p-8 rounded-3xl border border-slate-800 shadow-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div>
            <label
              htmlFor="fld-admin-cityeditor-tabs-tabgeneral-tsx-l196"
              className="text-[10px] font-bold text-slate-500 uppercase tracking-wide block mb-1.5"
            >
              Nome Città
            </label>
            <input
              id="fld-admin-cityeditor-tabs-tabgeneral-tsx-l196"
              value={city.name || ''}
          ...
          <div>
            <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wide block mb-1.5 flex justify-between">
              ...
              <button
                ...
                title={aiBlocked ? blockMessage : undefined}
                className="text-indigo-400 hover:text-white flex items-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed"
              >
        ...
        <div className="mb-6 bg-slate-950/30 p-4 rounded-xl border border-slate-800/50">
          <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wide block mb-1.5 flex justify-between items-center">
            ...
            <button
              ...
              disabled={!!fieldLoading || aiBlocked}
              title={aiBlocked ? blockMessage : undefined}
              className="text-amber-500 hover:text-white flex items-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div className="grid grid-cols-3 gap-4">
          <div>
            <label
              htmlFor="fld-admin-cityeditor-tabs-tabgeneral-tsx-l272"
              className="text-[10px] font-bold text-slate-500 uppercase tracking-wide block mb-1.5"
            >
              Regione
            </label>
            <input
              id="fld-admin-cityeditor-tabs-tabgeneral-tsx-l272"
          ...
          <div>
            <label
              htmlFor="fld-admin-cityeditor-tabs-tabgeneral-tsx-l282"
              className="text-[10px] font-bold text-slate-500 uppercase tracking-wide block mb-1.5"
            >
              Nazione
            </label>
            <input
              id="fld-admin-cityeditor-tabs-tabgeneral-tsx-l282"
              value={city.nation || ''}
          ...
          <div>
            <label
              htmlFor="fld-admin-cityeditor-tabs-tabgeneral-tsx-l292"
              className="text-[10px] font-bold text-slate-500 uppercase tracking-wide block mb-1.5"
            >
              Continente
            </label>
            <input
              id="fld-admin-cityeditor-tabs-tabgeneral-tsx-l292"
      ...
      <div className="bg-slate-900 p-8 rounded-3xl border border-slate-800 shadow-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          <div>
            <label
              htmlFor="fld-admin-cityeditor-tabs-tabgeneral-tsx-l310"
      ...
      <div className="bg-slate-900 p-8 rounded-3xl border border-slate-800 shadow-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wide block mb-1.5 flex justify-between">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  disabled={!!fieldLoading || aiBlocked}
                  title={aiBlocked ? blockMessage : undefined}
                  className="text-emerald-500 hover:text-white flex items-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {fieldLoading === 'coords' ? (
                    <Loader2 className="w-3 h-3 animate-spin" />
                  ) : (
          ...
          <div>
            <label
              htmlFor="fld-admin-cityeditor-tabs-tabgeneral-tsx-l406"
              className="text-[10px] font-bold text-slate-500 uppercase tracking-wide block mb-1.5"
            >
              Visitatori Annuali (Stima)
            </label>
            <input
              id="fld-admin-cityeditor-tabs-tabgeneral-tsx-l406"
              type="number"
              value={city.visitors || 0}
      ...
      <div className="bg-slate-900 p-8 rounded-3xl border border-slate-800 shadow-xl">
        ...
        <div className="flex justify-between items-center mt-2">
          <span
            className={`text-[10px] font-bold ${description.length > 150 ? 'text-red-500' : 'text-slate-500'}`}
          >
