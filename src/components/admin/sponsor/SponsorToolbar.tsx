...
import { Search, FileSpreadsheet, CalendarPlus, CheckSquare, Square, Trash2, Mail, MailOpen, ArrowUpDown, Loader2, Star } from 'lucide-react';
            ...
            <div className="flex flex-wrap gap-2 w-full md:w-auto">
                ...
                {showBelowRatingFilter && onToggleBelowRatingThreshold && (
                    ...
                    >
                        ...
                        <span className="hidden md:inline">{onlyBelowRatingThreshold ? 'SOTTO SOGLIA' : 'TUTTI I RATING'}</span>
                    </button>
                )}
