import { AlertTriangle, FileWarning, ImageOff, Info, MapPinOff, ShieldAlert } from 'lucide-react';
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-500 leading-tight">
                Numero totale di punti di interesse nel database (esclusi quelli eliminati).
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-500 leading-tight">
                POI generati dall'AI o importati manualmente che necessitano di revisione umana.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 h-full">
        ...
        <div className="space-y-2.5">
          <div className="flex items-center gap-2 text-xs text-slate-400">
            ...
            <span>
              <strong className="text-slate-300">No GPS:</strong> Coordinate 0,0
            </span>
          </div>
          <div className="flex items-center gap-2 text-xs text-slate-400">
            <ImageOff className="w-3.5 h-3.5 text-orange-400" />
            <span>
              <strong className="text-slate-300">No Image:</strong> Nessuna foto/placeholder
            </span>
          </div>
          <div className="flex items-center gap-2 text-xs text-slate-400">
            <FileWarning className="w-3.5 h-3.5 text-yellow-400" />
            <span>
              <strong className="text-slate-300">Short Desc:</strong> Descrizione &lt; 50 caratteri
            </span>
          </div>
          <div className="flex items-center gap-2 text-xs text-slate-400">
            <ShieldAlert className="w-3.5 h-3.5 text-indigo-400" />
            <span>
              <strong className="text-slate-300">Low Trust:</strong> Segnalato inaffidabile da AI
            </span>
          </div>
        </div>
      </div>
