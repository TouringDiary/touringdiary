import { Building2, ChevronDown, Filter, Flag, Globe, Map, MapPin, X } from 'lucide-react';
...
const SelectBox = ({
  ...
  <div className={`relative group min-w-0 ${disabled ? 'opacity-45 pointer-events-none' : ''}`}>
    <label
      htmlFor="fld-admin-cities-geocascadingfilters-tsx-l52"
      className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.14em] block mb-1.5"
    >
      {label}
    </label>
    <div className="relative">
      ...
      />
      <select
        id="fld-admin-cities-geocascadingfilters-tsx-l52"
        value={value}
