      ...
      <div className="bg-[#0b0f1a] w-full max-w-3xl h-[85vh] rounded-3xl border border-indigo-500/30 shadow-2xl flex flex-col overflow-hidden relative">
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-8 bg-[#0b0f1a]">
          {loading ? (
            ...
            <div
              className="prose prose-invert max-w-none prose-p:text-slate-300 prose-headings:text-white"
        ...
        <div className="p-5 border-t border-slate-800 bg-[#020617] shrink-0 text-center">
          <button
            type="button"
            onClick={onClose}
            className="w-full md:w-auto px-10 py-3 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl font-bold text-xs uppercase tracking-widest shadow-lg transition-all active:scale-95"
          >
            Ho Capito
          </button>
        </div>
