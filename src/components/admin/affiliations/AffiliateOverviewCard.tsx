...
import type {
  AffiliateAnalyticsStats,
  AffiliateFilterRange,
} from '../../../hooks/admin/useAffiliateAnalytics';
...
export const AffiliateOverviewCard = ({
  ...
  return (
    <div
      className={`bg-slate-900 border border-indigo-500/20 p-8 rounded-3xl shadow-xl relative group hover:border-indigo-500/40 transition-all overflow-hidden flex flex-col h-full ${isRefreshing ? 'opacity-70' : ''}`}
    >
      ...
      <div className="flex justify-between items-start mb-6 relative z-10">
        <div>
          ...
          <h3 className="text-4xl font-display font-bold text-white leading-none flex items-center gap-3">
            ...
            <span
              className={`text-sm font-black flex items-center gap-1 ${isPositive ? 'text-emerald-400' : 'text-rose-400'}`}
            >
      ...
      <div className="space-y-4 mt-auto relative z-10">
        <div className="flex items-center gap-3 bg-slate-950/50 p-3 rounded-2xl border border-slate-800">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs font-bold text-white truncate">
              {stats.topPartners[0]?.id || 'Nessuno'}
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 bg-slate-950/50 p-3 rounded-2xl border border-slate-800">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs font-bold text-white truncate">
              {stats.topProducts[0]?.id || 'Nessuno'}
            </p>
          </div>
        </div>
      </div>
