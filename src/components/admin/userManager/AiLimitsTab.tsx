...
import type { ModelAwareLimits } from '../../../services/subscriptionService';
  ...
  return (
    <div className="bg-gray-800 p-6 rounded-lg shadow-lg animate-in fade-in">
      <h2 className="text-2xl font-bold text-amber-400 mb-2">
        Configurazione Limiti AI (Sola Lettura)
      </h2>
      <p className="text-gray-400 mb-6">
        Mostra le quote AI incorporate in ogni piano tariffario attualmente attivo nel sistema
        tramite <code>pricing_versions</code>.
      </p>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-gray-700/50">
              <th className="p-3 border-b border-gray-600 text-gray-300 font-semibold">
                Nome Piano
              </th>
              ...
              <th className="p-3 border-b border-gray-600 text-amber-300 font-semibold">
                Flash / Mese
              </th>
              <th className="p-3 border-b border-gray-600 text-indigo-300 font-semibold">
                Pro / Mese
              </th>
              <th className="p-3 border-b border-gray-600 text-red-300 font-semibold">
                Daily Soft-Limit
              </th>
            ...
            {pricingVersions.map((version) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="p-3 font-mono text-amber-400">{limits?.models?.flash ?? '0'}</td>
                  <td className="p-3 font-mono text-indigo-400">{limits?.models?.pro ?? '0'}</td>
                  <td className="p-3 font-mono text-red-400">{limits?.soft_daily_limit ?? '0'}</td>
