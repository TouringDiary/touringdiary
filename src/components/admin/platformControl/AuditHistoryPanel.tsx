...
export const AuditHistoryPanel: React.FC<AuditHistoryPanelProps> = ({ canExport }) => {
    ...
    const handleExport = () => {
        ...
        a.click();
        // Defer revoke so the browser can start the download before the URL is invalidated.
    ...
    return (
        <AdminSectionCard
            icon={History}
            title="Storico Audit"
            subtitle="Lettura modifiche Centro di Controllo (DL-P05). Ordinamento dal più recente."
        >
