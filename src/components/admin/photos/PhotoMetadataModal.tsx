    ...
    >
      ...
      >
        ...
        <div className="space-y-4">
          <div>
            <label
              htmlFor="fld-admin-photos-photometadatamodal-tsx-l62"
            ...
            <div className="relative">
              ...
              <select
                id="fld-admin-photos-photometadatamodal-tsx-l62"
                value={modal.locationName}
                onChange={(e) => onChange({ ...modal, locationName: e.target.value })}
          ...
          <div>
            <label
              htmlFor="fld-admin-photos-photometadatamodal-tsx-l83"
              className="text-[10px] font-bold text-slate-500 uppercase block mb-1"
            >
              Descrizione
            </label>
            <textarea
              id="fld-admin-photos-photometadatamodal-tsx-l83"
          ...
          {modal.promoteOnSave && (
            <p className="text-[10px] text-slate-500 leading-relaxed border-l-2 border-amber-500/40 pl-3">
              La promozione a Official rende la foto visibile nella Galleria Official della città
              selezionata.
            </p>
          )}
        </div>
