    ...
    <HeaderPopover
      ...
      trigger={
        ...
        >
          ...
          <span className="text-[8px] font-black uppercase tracking-widest opacity-70 mt-0.5 pointer-events-none">
            AI Credits
          </span>
        </div>
      }
    ...
    >
      ...
      <div className="space-y-2">
        ...
        <div className="relative mt-6 p-5 bg-indigo-600/10 border border-indigo-500/20 rounded-[1.75rem] overflow-hidden group">
          ...
          <span className="relative z-10 text-[9px] font-black text-indigo-300 uppercase tracking-[0.2em] mb-4 block">
            SALDO DISPONIBILE
          </span>

          <div className="relative z-10 grid grid-cols-2 gap-4">
            <div className="flex flex-col">
              <span className="text-[8px] text-slate-500 uppercase font-black tracking-widest mb-1">
                TOTALE FLASH
              </span>
