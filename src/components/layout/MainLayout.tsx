...
function resolveMobileActiveSection(input: {
  ...
  if (activeModal === 'global' && modalSection === MOBILE_SECTION_COMMUNITY)
    return MOBILE_SECTION_COMMUNITY;
  ...
  if (activeModal === 'global' && modalSection === MOBILE_SECTION_SPONSORS)
    return MOBILE_SECTION_SPONSORS;
  return null;
}
