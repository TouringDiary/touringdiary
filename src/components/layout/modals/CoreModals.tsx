...
const SetUsernameModal = React.lazy(() => import('../../modals/SetUsernameModal').then(module => ({ default: module.SetUsernameModal })));
...
interface CoreModalsModalProps {
    mandatory?: boolean;
    message?: string;
    page?: string;
}
...
interface CoreModalsProps {
    ...
    modalProps: CoreModalsModalProps;
    closeModal: () => void;
    onConfirmGps: () => void;
                ...
                <div className="td-modal-overlay bg-black/90 backdrop-blur-sm p-4 animate-in fade-in zoom-in-95" style={{ zIndex: Z_OVERLAY }}>
                    ...
                    >
                        ...
                        <p className="text-slate-400 text-sm mb-4 leading-relaxed">
                            ...
                            <strong className="text-white block mt-2 text-lg">+20 XP</strong>
