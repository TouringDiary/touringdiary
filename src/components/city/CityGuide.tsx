        ...
        >
            ...
            <div className="w-12 md:w-16 bg-[#0f172a] border-l border-slate-800 flex flex-col shrink-0">
                ...
                <button onClick={handleThumbClick} className={`${sideBtnClass} border-b border-slate-800 ${isVoted ? 'bg-blue-600 text-white' : 'text-slate-500 hover:text-blue-400'}`} title="Voto">
                    ...
                    <span className="text-[7px] font-black uppercase">{localVotes}</span>
                </button>
                <button onClick={handleReviewClick} className={`${sideBtnClass} text-slate-500 hover:text-amber-400`} title="Valuta">
                    ...
                    <span className="text-[7px] font-black uppercase">VALUTA</span>
                </button>
            </div>
        </div>
    );
...
export const CityGuide = ({ 
    ...
    // --- SPONSOR PREPARATION (MOBILE ONLY) ---
            ...
            return (
                <div className="h-40 w-full">
                     <UniversalCard 
                        ...
                        onLike={() => {}} 
                        isLiked={false} 
                        variant="vertical" // Use Vertical Variant of UniversalCard
                        fluid={true} 
    ...
    return (
        <div className="px-0 md:px-2 py-4 md:p-8 pb-24">
            ...
            {/* MOBILE SPONSOR BLOCK (ONLY VISIBLE ON MOBILE) */}
            <div className="lg:hidden mt-12 px-2 border-t border-slate-800/50 pt-8">
