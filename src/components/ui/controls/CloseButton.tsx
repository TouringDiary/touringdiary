...
export const CloseButton: React.FC<CloseButtonProps> = ({
  ...
  const variantStyles = {
    primary:
      'bg-red-600 text-white rounded-full hover:bg-red-700 shadow-lg shadow-red-900/40 active:scale-95 transition-all duration-300',
    minimal:
      'bg-slate-800 text-slate-400 rounded-full hover:bg-red-600 hover:text-white transition-all duration-300 border border-slate-700 active:scale-95',
    ghost:
      'text-slate-500 hover:text-white rounded-full hover:bg-slate-800/80 transition-all duration-300 active:scale-95',
  };
