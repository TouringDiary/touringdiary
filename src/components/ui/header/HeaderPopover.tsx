...
interface HeaderPopoverProps {
  ...
  onOpen?: () => void;
  onClose?: () => void;
  /** Accessible name when the trigger content has no visible text */
    ...
    return (
      <div className="relative flex items-center">
        <button
          ...
          className="cursor-pointer border-0 bg-transparent p-0 appearance-none"
          aria-label={triggerAriaLabel}
          aria-expanded={isOpen}
          aria-controls={isOpen ? `header-popover-panel-${uniqueId}` : undefined}
        >
          {trigger}
        </button>
        {renderPanel()}
