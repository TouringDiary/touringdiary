 ...
 */
export const ExportLogo: React.FC<ExportLogoProps> = ({ width, height, iconOnly = false }) => {
  ...
  return (
    <svg
      ...
      role="img"
      aria-label="TouringDiary"
    >
      <title>TouringDiary</title>
      ...
      <g transform="translate(4, 4)">
        ...
        <g clipPath="url(#globeMaskCircle_export)">
          ...
          <path
            d="M25 7 C 5 7, 5 91, 25 91 M25 7 C 45 7, 45 91, 25 91"
            stroke="white"
            strokeWidth="0.5"
            opacity="0.15"
            fill="none"
        ...
        <g transform="translate(25, 25) scale(0.55) rotate(-10)">
          <g transform="rotate(-35)">
            <path
              ...
              stroke="url(#cometTrail_export)"
              strokeWidth="6"
              strokeLinecap="round"
              fill="none"
            />
            <path
              d="M22 0 C 22 -2, 17 -3, 12 -3 L -12 -2 L -14 -9 L -17 -9 L -15 -2 L -20 -1 L -22 -4 L -24 -4 L -21 0 L -24 4 L -22 4 L -20 1 L -15 2 L -17 9 L -14 9 L -12 2 L 12 2 C 17 3, 22 2, 22 0 Z"
              fill="white"
              stroke="#94a3b8"
              strokeWidth="1.2"
            />
