    ...
    >
      ...
      >
        ...
        <div className="text-white text-center">
          ...
          <h2 className="text-2xl font-bold mb-3 font-display uppercase tracking-wide">
            Attenzione: Limite Quota
          </h2>
          <p className="text-slate-400 text-sm mb-8 leading-relaxed">
            Hai raggiunto il limite di utilizzo giornaliero consigliato. Vuoi continuare utilizzando
            i tuoi crediti mensili o passare a un piano superiore?
          </p>
