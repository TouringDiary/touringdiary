...
export const DateChangeWarningModal = ({
  isOpen,
  onClose,
  onConfirm,
  lostDaysCount,
}: DateChangeWarningModalProps) => {
    ...
    >
      ...
      >
        ...
        <div className={`${bodyShell} flex flex-col items-center text-center gap-4 min-h-0`}>
          ...
          <p
            id="date-change-warning-desc"
            className={`${modalSubtitleShell} leading-relaxed whitespace-pre-line mb-4`}
          >
            {msg.body ||
              `Riducendo la durata del viaggio, perderai le tappe inserite negli ultimi ${lostDaysCount} giorni che verranno rimossi.`}
          </p>
