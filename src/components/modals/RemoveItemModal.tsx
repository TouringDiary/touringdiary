        ...
        <header className={headerShell}>
          <div className="flex items-center gap-3 pr-10 min-w-0">
            ...
            <div className="min-w-0">
              <h3 id="remove-item-title" className={`${modalTitleShell} leading-none`}>
                Rimuovi Tappa
              </h3>
              <p id="remove-item-desc" className={`${modalSubtitleShell} mt-1 truncate`}>
                "{poiName}" è presente più volte
              </p>
            </div>
          </div>
        </header>
