import { AlertTriangle, LogIn, MapPin, Printer } from 'lucide-react';
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">
                  Esplora le città e clicca sul tasto <strong>"+"</strong> nelle schede dei luoghi
                  per aggiungerli al diario.
                </p>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <p className="text-xs text-emerald-200/80">
                  ...
                  <button
                    ...
                    className="text-white underline font-bold ml-1 hover:text-emerald-300"
                  >
                    Accedi o Registrati
                  </button>{' '}
                  per salvare il tour nel cloud.
                </p>
              </div>
            </div>
          )}
