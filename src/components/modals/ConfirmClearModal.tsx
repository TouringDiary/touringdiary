      ...
      >
        ...
        <div className={`${bodyShell} flex flex-col items-center text-center gap-4 min-h-0`}>
          ...
          <p
            ...
            className={`${modalSubtitleShell} leading-relaxed whitespace-pre-line mb-6`}
          >
            {msg.body ||
              'Questa azione cancellerà tutte le tappe, le date e il nome del viaggio. Non potrai annullare questa operazione.'}
          </p>
