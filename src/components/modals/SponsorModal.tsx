...
import { resolveSponsorableGroup, SponsorPricingSelector } from './sponsor/SponsorPricingSelector';
...
export const SponsorModal = ({ isOpen, onClose, user, initialType }: SponsorModalProps) => {
  ...
  const handlePricingSelection = useCallback(
    (id: string | null) => {
      setSelectedPlan(id);
    },
    [setSelectedPlan],
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1 font-medium">
                Entra nel network di Touring Diary
              </p>
            </div>
          </div>
