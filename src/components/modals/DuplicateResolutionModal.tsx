import { AlertCircle, Calendar, Copy, RefreshCw } from 'lucide-react';
      ...
      >
        ...
        <div className={`${bodyShell} min-h-0`}>
          <div className="flex items-start gap-4 mb-6 pr-10">
            ...
            <div>
              <h3 id="duplicate-resolution-title" className={`${modalTitleShell} mb-1`}>
                Tappa già presente
              </h3>
              <p id="duplicate-resolution-desc" className={modalSubtitleShell}>
                Hai già inserito <strong className="text-white">{newItemPoi.name}</strong> nel tuo
                diario:
              </p>
          ...
          <div className="space-y-3">
            <p className="text-xs text-slate-500 uppercase font-bold tracking-widest text-center mb-2">
              Cosa vuoi fare?
            </p>
            ...
            {days.length > 0 && (
              <div className="space-y-1.5">
                <label
                  htmlFor="fld-modals-duplicateresolutionmodal-tsx-l102"
                  className="text-[10px] font-bold uppercase text-slate-500 flex items-center gap-1.5 ml-1"
                >
                  <Calendar className="w-3.5 h-3.5" /> Giorno di destinazione
                </label>
                <select
                  id="fld-modals-duplicateresolutionmodal-tsx-l102"
                  value={selectedDay}
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-[10px] text-slate-400 font-normal">
                  Inserisci al Giorno {selectedDay + 1}, {targetTime}
                </div>
              </div>
            </button>
          </div>
