...
export const GpsErrorModal = ({
  ...
  return createPortal(
    <div
      className="td-modal-overlay bg-black/90 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in pointer-events-auto"
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center text-center gap-4">
          <div
            className={`w-16 h-16 rounded-full flex items-center justify-center border-2 shadow-lg ${isCritical ? 'bg-red-900/20 border-red-500/50' : 'bg-slate-800 border-slate-600'}`}
          >
            {isCritical ? (
          ...
          <div>
            ...
            {isCritical && (
              <div className="mt-4 bg-slate-950 p-3 rounded-lg border border-slate-800 text-left text-xs text-slate-400">
                <p className="font-bold text-white mb-1 uppercase tracking-wide">
                  Cosa controllare:
                </p>
