...
import { ScrollText, BookOpen, PenTool, Calendar, Info } from 'lucide-react';
...
export const HistoryModal = ({ isOpen, onClose, city, openSuggestion, customText }: Props) => {
    ...
    const renderPatronContent = () => {
        ...
        return (
            <div className="max-w-3xl mx-auto relative z-floating-panel animate-in fade-in slide-in-from-right-4">
    ...
    return createPortal(
        <div className="td-modal-overlay bg-black/95 backdrop-blur-md flex items-center justify-center p-0 md:p-4 animate-in fade-in" style={{ zIndex: Z_OVERLAY }} onClick={onClose}>
            <div 
