...
import type { PointOfInterest, ShopCategory, ShopPartner } from '../../types/index';
import { open3DView, openMap } from '../../utils/common';
        ...
        <div className="min-w-0 flex-1">
          ...
          {shop ? (
            <div className="flex flex-wrap items-center gap-x-3 gap-y-1 mt-2">
              <span className="text-[10px] md:text-xs text-indigo-400 font-black uppercase tracking-widest">
                {shop.category}
              </span>
      ...
      <div className="flex items-center gap-2 md:gap-3 shrink-0 ml-2">
        ...
        {shop && (
          <>
            ...
            <button
              type="button"
              className="hidden md:flex bg-indigo-600 hover:bg-indigo-500 text-white px-5 py-2.5 rounded-xl font-black uppercase text-[10px] tracking-widest items-center gap-2 shadow-xl active:scale-95 transition-all"
            >
