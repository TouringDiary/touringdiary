  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <svg
        ...
        role="img"
        aria-label="TouringDiary mascot"
      >
        <title>TouringDiary mascot</title>
        <defs>
        ...
        <g clipPath="url(#globeMaskCircle)">
          ...
          <path
            d="M60 18 C 40 18, 40 102, 60 102 M60 18 C 80 18, 80 102, 60 102 M18 60 C 18 45, 102 45, 102 60 M18 60 C 18 75, 102 75, 102 60"
            stroke="white"
            strokeWidth="0.5"
            opacity="0.15"
            fill="none"
