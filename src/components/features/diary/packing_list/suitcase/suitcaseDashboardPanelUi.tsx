...
export const SUITCASE_DASHBOARD_PANEL_PADDING_CLASS = 'px-5 py-4 md:px-6 md:py-5 lg:py-6';

export const SUITCASE_DASHBOARD_SECTION_BAR_CLASS = 'w-1 h-5 bg-amber-500 rounded-full shrink-0';
...
export const SUITCASE_GUIDE_COMPACT_PADDING_CLASS = 'px-5 py-3.5 md:px-6 md:py-4';
