...
export const useFloatingPanelModals = () => {
  ...
  const [pendingWorkspaceCreate, setPendingWorkspaceCreate] =
    useState<PendingWorkspaceCreate | null>(null);
  ...
  return {
    ...
    showDraftOverwriteModal,
    setShowDraftOverwriteModal,
    showUnsavedChangesModal,
    setShowUnsavedChangesModal,
    showRecommendedSuitcaseModal,
    ...
    isCreatingFromConfiguration,
    setIsCreatingFromConfiguration,
    suitcaseToAssociate,
    setSuitcaseToAssociate,
