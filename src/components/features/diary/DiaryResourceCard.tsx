import { Eye, Globe, Phone, Pin, Trash2 } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col min-w-0 pr-1">
        ...
        <div
          className={`flex justify-between items-center ${ROW_HEIGHT} w-full border-t border-stone-100/50`}
        >
          ...
          {poi.contactInfo?.phone && (
            <div className="flex items-center h-full">
              <a
                ...
                className="flex items-center gap-1 text-[10px] font-bold text-stone-600 hover:text-emerald-600 transition-colors bg-white/50 px-1.5 py-0.5 rounded border border-stone-200"
              >
