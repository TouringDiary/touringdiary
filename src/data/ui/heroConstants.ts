...
export const FALLBACK_CONTINENTS = [{ value: 'europa', label: 'Europa', disabled: false }];
export const FALLBACK_NATIONS = [{ value: 'italia', label: 'Italia', disabled: false }];
export const FALLBACK_REGIONS = [{ value: 'campania', label: 'Campania', disabled: false }];
