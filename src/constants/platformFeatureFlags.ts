...
export const PLATFORM_FEATURE_FLAG_ADMIN_HELP: Record<PlatformFeatureFlagKey, string> = {
  ...
  [PLATFORM_FEATURE_FLAG_KEYS.MODERATION_COMMUNITY_POSTS]:
    'Consente domande e risposte nella sezione Community → Consigli.\n' +
...
export const PLATFORM_FLAG_MESSAGE_CATALOG: readonly PlatformMessageTemplateCatalogEntry[] = [
  ...
  },
  {
    ...
    defaultTitle: 'Chat non disponibile',
    defaultBody: 'La messaggistica verso il Negozio Digitale è temporaneamente non disponibile.',
  },
  {
  ...
  },
  {
    ...
    label: 'Consigli Community sospesi',
    description: 'Messaggio quando feature.moderation.community_posts (Consigli Community) è OFF.',
    defaultTitle: 'Consigli Community sospesi',
  ...
  },
  {
    ...
    description:
      'Messaggio informativo quando feature.gamification.rewards è OFF (freeze premi; XP resta attivo).',
